...
from tests.fixtures.images import create_sample_photo_with_exif, create_test_image
...
def generate_sample_images() -> None:
    ...
    img3 = create_sample_photo_with_exif(datetime_original="2023:07:15 14:30:00", make="TestCamera", model="Model X")
    img3.rename(output_dir / "test_with_exif.jpg")
    print("  Created: test_with_exif.jpg")
